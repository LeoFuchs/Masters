...
def similarity_with_improvement(QGS, result_with_improvement, manual_exit_with_improvement):
    ...
    print("Number of QGS articles founded (with improvement):", counter)
...
def similarity_wihout_improvement(QGS, result_without_improvement, manual_exit_without_improvement):
    ...
    print("Number of QGS articles founded (without improvement):", counter)
...
print("\n")
scopus_without_improvement(string_no_improvement)
scopus_with_improvement(string_with_improvement)
...
similarity_with_improvement(QGS, result_with_improvement, manual_exit_with_improvement)
similarity_wihout_improvement(QGS, result_without_improvement, manual_exit_without_improvement)