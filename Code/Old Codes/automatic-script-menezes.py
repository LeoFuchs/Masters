# encoding: utf-8
# run with python automatic-script-menezes.py >> menezes-out.txt
import gensim
import Levenshtein
import csv
import pandas as pd
...
def open_necessary_files():
    ...
    """
    gs = pd.read_csv('/home/fuchs/Documentos/MESTRADO/Masters/Files-QGS/revisao-menezes/GS.csv', sep='\t')
...
def similarity_score_qgs(qgs, result_name_list, manual_comparation):
    ...
    for len_qgs, l in enumerate(open('/home/fuchs/Documentos/MESTRADO/Masters/Files-QGS/revisao-menezes/QGS.csv')):
        pass
...
def similarity_score_gs(gs, result_name_list, manual_comparation):
    ...
    for len_gs, l in enumerate(open('/home/fuchs/Documentos/MESTRADO/Masters/Files-QGS/revisao-menezes/GS.csv')):
        pass
    for len_result, l in enumerate(open('/home/fuchs/Documentos/MESTRADO/Masters/Code/Exits/Result.csv')):
        pass
